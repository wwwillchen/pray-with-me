        ...
        return (React.createElement(View, { style: styles.container },
            React.createElement(ScrollView, { style: styles.container, contentContainerStyle: styles.contentContainer },
                ...
                React.createElement(View, { style: styles.getStartedContainer },
                    ...
                    React.createElement(Text, { style: styles.getStartedText }, "hi. Change this text and your app will automatically reload.")),
...
const styles = StyleSheet.create({
    ...
    tabBarInfoContainer: Object.assign({ position: "absolute", bottom: 0, left: 0, right: 0 }, Platform.select({
        ios: {
            shadowColor: "black",
